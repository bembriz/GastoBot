...
class GoogleSheetsClient:
    ...
    async def create_monthly_headers(self, sheet_name: str):
        ...
        headers = [
            "Fecha del gasto", "Categoría", "Descripción",
            "Empleado", "Pagado por", "Actividades",
            "Fecha contable", "Cuenta", "Precio unitario",
            "Cantidad", "Incluir impuestos", "Importe de impuestos",
            "Total", "Estado", "Banco", "Transaccion",
        ]
